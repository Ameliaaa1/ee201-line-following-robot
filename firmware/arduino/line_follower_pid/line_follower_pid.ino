...
const float proportion  = 20;
const float integral    = 0;
const float derivative  = 10;

const int numMeas = 40; // TODO: Replace "___", and assign number of calibration measurements
                         //   setting numMeas to 40 as in code 10.4 is recommended
...
void fastBlink() {
  digitalWrite(led_Pin, 1); // TODO: Replace "___", and turn on the LED
  delay(100); // wait for 100 milliseconds

  digitalWrite(led_Pin, 0); // TODO: Replace "___", and turn off the LED
  delay(100); // wait for 100 milliseconds
} // end fastBlink()
...
void Calibrate() { 
  ...
  for (int calii = 0; calii < numMeas; calii++) { // TODO: Replace "___", and repeat the section of code
    ...
    for (int ci = 0; ci < 7; ci++) { // TODO: Replace "___", and loop over all of the LDRs
  ...
  for (int cm = 0; cm < 7; cm++) { // TODO: Replace "___", and loop over all of the LDRs
 ...
 // Wait to move from White to Black Surface
  for (int calii = 0; calii < 4; calii++) { // wait ten blinks for the cart to be repositioned
    slowBlink();
  }
